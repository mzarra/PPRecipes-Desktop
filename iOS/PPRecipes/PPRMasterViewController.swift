...
class PPRMasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
  ...
  func frcExmaple2() {
    //START:fetchedResultsController2
    let fetch = NSFetchRequest(entityName: "Recipe")
  ...
  //START:numberOfSectionsInTableView
  ...
  //START:controllerWillChangeContent
  func controllerWillChangeContent(controller: NSFetchedResultsController) {
    tableView.beginUpdates()
  }
  //END:controllerWillChangeContent

  //START:didChangeSection
  ...
  //END:didChangeSection

  //START:didChangeObject
  func controller(controller: NSFetchedResultsController,
  ...
  //START:sectionIndexTitleForSectionName
  func controller(controller: NSFetchedResultsController,
    sectionIndexTitleForSectionName sectionName: String) -> String? {
    return "[\(sectionName)]"
  }
  //END:sectionIndexTitleForSectionName

  //START:controllerDidChangeContent
